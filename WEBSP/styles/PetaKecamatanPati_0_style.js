...
var style_PetaKecamatanPati_0 = function(feature, resolution){
    ...
    var value = feature.get("Sapipotong");
    var labelText = "";
    size = 0;
    ...
    if (value > 1737.000000 && value <= 3584.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 3584.000000 && value <= 7609.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 7609.000000 && value <= 12980.000000) {
            style = [ new ol.style.Style({
