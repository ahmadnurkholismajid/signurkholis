...
var style_PetaKecamatanPati_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Ayam Ras");
    var labelText = "";
    size = 0;
    ...
    if (value > 3500.000000 && value <= 10500.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 10500.000000 && value <= 26000.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 26000.000000 && value <= 45000.000000) {
            style = [ new ol.style.Style({
