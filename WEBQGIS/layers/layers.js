...
lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.set('fieldAliases', {'Kecamatan': 'Kecamatan', 'Kabupaten': 'Kabupaten', 'Sapipotong': 'Sapipotong', 'Sapi perah': 'Sapi perah', 'Kerbau': 'Kerbau', 'Kambing': 'Kambing', 'Domba': 'Domba', 'Babi': 'Babi', 'Ayam Ras': 'Ayam Ras', 'AyamKampung': 'AyamKampung', });
lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.set('fieldImages', {'Kecamatan': 'TextEdit', 'Kabupaten': 'TextEdit', 'Sapipotong': 'TextEdit', 'Sapi perah': 'TextEdit', 'Kerbau': 'TextEdit', 'Kambing': 'TextEdit', 'Domba': 'TextEdit', 'Babi': 'TextEdit', 'Ayam Ras': 'TextEdit', 'AyamKampung': 'TextEdit', });
lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.set('fieldLabels', {'Kecamatan': 'inline label', 'Kabupaten': 'inline label', 'Sapipotong': 'inline label', 'Sapi perah': 'inline label', 'Kerbau': 'inline label', 'Kambing': 'inline label', 'Domba': 'inline label', 'Babi': 'inline label', 'Ayam Ras': 'inline label', 'AyamKampung': 'inline label', });
